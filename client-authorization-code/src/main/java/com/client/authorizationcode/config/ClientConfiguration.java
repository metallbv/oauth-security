package com.client.authorizationcode.config;
...
public class ClientConfiguration {
	...
	public OAuth2ProtectedResourceDetails authorizationCode() {
		...
		resourceDetails.setClientId("client_code");
		resourceDetails.setClientSecret("code123");
	...
	public OAuth2RestTemplate oauth2RestTemplate() {
		...
		AccessTokenProviderChain provider = new
				...
				//AccessTokenProviderChain(Arrays.asList(new CustomAuthorizationCodeAccessTokenProvider()));
